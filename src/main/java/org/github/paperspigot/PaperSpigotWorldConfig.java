...
public class PaperSpigotWorldConfig
{
    ...
    public boolean doTickSleepCheck, doTickBiomeCacheCleanup, doTickVillages, doTickWeather, doTickIceAndSnow, doTickThunder, doTickMoodSound, doTickRecheckGaps;
    private void doTickChanges() {
        ...
        doTickVillages = getBoolean("do-tick.villages", true);
        ...
        doTickRecheckGaps = getBoolean("do-tick.recheck-gaps", true);
    }
}
