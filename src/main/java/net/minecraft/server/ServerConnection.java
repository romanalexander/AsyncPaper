...
public class ServerConnection {
    ...
    private ThreadPoolExecutor connectionHandlerService = new ThreadPoolExecutor(PaperSpigotConfig.connectionHandlerThreads, PaperSpigotConfig.connectionHandlerThreads, 0L, TimeUnit.MILLISECONDS, new ArrayBlockingQueue<Runnable>(0xffffff), new NamedThreadFactory("connection-handler-worker"));
