...
public class PersistentVillage extends PersistentBase {
    ...
    public synchronized void a(int i, int j, int k) {
        if (this.b.size() <= 64) {
            if (!this.d(i, j, k)) {
    ...
    public synchronized Village getClosestVillage(int i, int j, int k, int l) {
    ...
    private synchronized VillageDoor b(int i, int j, int k) {
    ...
    private synchronized void c(int i, int j, int k) {
    ...
    private synchronized boolean d(int i, int j, int k) {
    ...
    public synchronized void b(NBTTagCompound nbttagcompound) {
